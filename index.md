...
- **[May. 2026]** Our paper on multi-workflow scheduling via reinforcement learning-assisted evolutionary optimization has been accepted to *SWEVO*.
- **[May. 2026]** Our paper on cloud-edge task offloading via reinforcement learning-driven interval multi-objective evolutionary algorithms has been accepted to *EAAI*.
- **[Dec. 2025]** Our paper on multi-agent AI task scheduling via spatial perception and action decoupling has been accepted to *ToN*.
